...
- Registered overlays: **two** (`stacks-errata-a04446e-r1` and
  `stacks-errata-a04446e-r2`), each admitted from a manifest-complete candidate
  after independent replay.
- Active candidate-namespace leases: **four** (`fac`, `tohoku`, `gaga`,
  `errata/r3`). The first three are held by task
  `019fca5a-c29e-7330-acdc-c93f4a3dc9fb`; `errata/r3` is held by canon task
